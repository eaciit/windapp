            ...
            columns       : [
                { field: "Project", title: "Name", width: 110,headerAttributes: { style: "text-align: center" },attributes: { style: "padding-left: 20px" }},
                {
                    ...
                    columns: [
                        ...
                        { field: "PotentialPower", title: "Potential Power <br>(KWh)", width: 100,headerAttributes: { style: "text-align: center" },attributes:{ style: "text-align: right" },format: "{0:n2}"},
                        { field: "Power", title: "Actual Power <br> (KW)", width: 100,headerAttributes: { style: "text-align: center" },attributes:{ style: "text-align: right" },format: "{0:n2}"},
                    ]
                },
                {
                    title: "Last 24 Hours",
                    ...
                    columns: [
                        ...
                        { field: "PotentialPowerLast24Hours", title: "Potential Power <br>(KWh)", width: 100,headerAttributes: { style: "text-align: center" },attributes:{ style: "text-align: right" },format: "{0:n2}"},
                        { field: "PowerLast24Hours", title: "Actual Power <br> (KW)", width: 100,headerAttributes: { style: "text-align: center" },attributes:{ style: "text-align: right" },format: "{0:n2}"},
                    ]
                },
                {
                    title: "Last Week",
                    ...
                    columns: [
                        ...
                        { field: "PotentialPowerLastWeek", title: "Potential Power <br>(KWh)", width: 100,headerAttributes: { style: "text-align: center" },attributes:{ style: "text-align: right" },format: "{0:n2}"},
                        { field: "PowerLastWeek", title: "Actual Power <br> (KW)", width: 100,headerAttributes: { style: "text-align: center" },attributes:{ style: "text-align: right" },format: "{0:n2}"},
                    ]
                },
                {
                    title: "MTD",
                    ...
                    columns: [
                        ...
                        { field: "PotentialPowerMTD", title: "Potential Power <br>(KWh)", width: 100,headerAttributes: { style: "text-align: center" },attributes:{ style: "text-align: right" },format: "{0:n2}"},
                        { field: "PowerMTD", title: "Actual Power <br> (KW)", width: 100,headerAttributes: { style: "text-align: center" },attributes:{ style: "text-align: right" },format: "{0:n2}"},
                    ]
                },
                {
                    title: "YTD",
                    ...
                    columns: [
                        ...
                        { field: "PotentialPowerYTD", title: "Potential Power<br>(KWh)", width: 100,headerAttributes: { style: "text-align: center" },attributes:{ style: "text-align: right" },format: "{0:n2}"},
                        { field: "PowerYTD", title: "Actual Power <br> (KW)", width: 100,headerAttributes: { style: "text-align: center" },attributes:{ style: "text-align: right" },format: "{0:n2}"},
                    ]
                },
            ]
        });
