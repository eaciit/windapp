            ...
            columns       : [
                { field: "Project", title: "Name", width: 110,headerAttributes: { style: "text-align: center" },attributes: { style: "padding-left: 20px" }},
                {
                    ...
                    columns: [
                        ...
                        { field: "PotentialPower", title: "Pot. Power <br>(MWh)", width: 100,headerAttributes: { style: "text-align: center" },attributes:{ style: "text-align: right" },format: "{0:n2}"},
                ...
                },
                {
                    ...
                    columns: [
                        ...
                        { field: "PotentialPowerLast24Hours", title: "Pot. Power <br>(MWh)", width: 100,headerAttributes: { style: "text-align: center" },attributes:{ style: "text-align: right" },format: "{0:n2}"},
                ...
                },
                {
                    ...
                    columns: [
                        ...
                        { field: "PotentialPowerLastWeek", title: "Pot. Power <br>(MWh)", width: 100,headerAttributes: { style: "text-align: center" },attributes:{ style: "text-align: right" },format: "{0:n2}"},
                ...
                },
                {
                    ...
                    columns: [
                        ...
                        { field: "PotentialPowerMTD", title: "Pot. Power <br>(MWh)", width: 100,headerAttributes: { style: "text-align: center" },attributes:{ style: "text-align: right" },format: "{0:n2}"},
                ...
                },
                {
                    ...
                    columns: [
                        ...
                        { field: "PotentialPowerYTD", title: "Pot. Power<br>(MWh)", width: 100,headerAttributes: { style: "text-align: center" },attributes:{ style: "text-align: right" },format: "{0:n2}"},
