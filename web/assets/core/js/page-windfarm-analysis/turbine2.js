		...
		if(obj.dataSource.data.length > 0) {
			...
			$('#gridTurbine2').find('tr').each(function(){
				...
				if (data!=null) {
					...
					chart1.kendoChart(wfa.GetChartConfig(data.Roll12Days.ValueAvg, rowSelected));
					chart2.kendoChart(wfa.GetChartConfig(data.Roll12Weeks.ValueAvg, rowSelected));
					chart3.kendoChart(wfa.GetChartConfig(data.Roll12Months.ValueAvg, rowSelected));
					chart4.kendoChart(wfa.GetChartConfig(data.Roll12Quarters.ValueAvg, rowSelected));
