		...
		$('#gridDGRReport').kendoGrid({
	      dataSource: {
	        ...
	        aggregate: [
                ...
                { field: "LoWindTime", aggregate: "sum" },
                { field: "DowntimeHours", aggregate: "sum" },
            ],
	      },
	      sortable: true,
	      filterable: false,
	      ...
	      columns: [
	        ...
	        { title: "Turbine", field: "TurbineName", headerAttributes: { style:"text-align: center" }, attributes:{ class:"align-center" }, format: "{0:n2}", width: 120},
	        ...
	        { title: "Opr. Hrs. (HH:mm:ss)", field: "OkTime", headerAttributes: { style:"text-align: center" }, attributes:{ class:"align-center" }, width: 120, template: "#= page.fancyTimeFormat(OkTime) #" ,footerTemplate: "#=page.fancyTimeFormat(sum)#",footerAttributes: {style: "text-align:center;"}},
	        { title: "Lull Hrs. (HH:mm:ss)", field: "LoWindTime", headerAttributes: { style:"text-align: center" }, attributes:{ class:"align-center" }, format: "{0:n2}", width: 120,template: "#= page.fancyTimeFormat(LoWindTime) #" ,footerTemplate: "#=page.fancyTimeFormat(sum)#",footerAttributes: {style: "text-align:center;"}},
	        { title: "Breakdown Hrs. (HH:mm:ss)", field: "DowntimeHours", headerAttributes: { style:"text-align: center" }, attributes:{ class:"align-center" }, format: "{0:n2}", width: 120,template: "#= page.fancyTimeFormat(DowntimeHours) #" ,footerTemplate: "#=page.fancyTimeFormat(sum)#",footerAttributes: {style: "text-align:center;"}},
