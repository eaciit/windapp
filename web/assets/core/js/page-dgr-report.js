		...
		$('#gridDGRReport').kendoGrid({
	      dataSource: {
	        ...
	        aggregate: [
                ...
                { field: "LoWindTime", aggregate: "average" },
	      ...
	      columns: [
	        ...
	        { title: "Lull Hrs. (HH:mm:ss)", field: "LoWindTime", headerAttributes: { style:"text-align: center" }, attributes:{ class:"align-center" }, format: "{0:n2}", width: 120,template: "#= page.fancyTimeFormat(LoWindTime) #" ,footerTemplate: "#=page.fancyTimeFormat(average)#",footerAttributes: {style: "text-align:center;"}},
