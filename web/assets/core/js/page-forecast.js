        ...
        $("#gridForecasting").kendoGrid({
            ...
            columns: [
                ...
                { 
                    ...
                    format: '{0:n0}',
                    attributes: {
                        "class": "#:(AvaCap != null && moment(TimeStamp).utc().add(15, 'minutes').isAfter(moment(pg.TimeFilter()).utc())?'cell-editable':'cell-editable-no')# tooltipster tooltipstered",
                        "title": "#:(AvaCap != null && moment(TimeStamp).utc().add(15, 'minutes').isAfter(moment(pg.TimeFilter()).utc())?'Click to edit this value':'Not allowed to edit this value')#",
                    },
                },
                ...
                { 
                    ...
                    format: '{0:n2}',
                    attributes: {
                        "class": "#:(SchFcast != null && moment(TimeStamp).utc().add(15, 'minutes').isAfter(moment(pg.TimeFilter()).utc())?'cell-editable':'cell-editable-no')# tooltipster tooltipstered",
                        "title": "#:(SchFcast != null && moment(TimeStamp).utc().add(15, 'minutes').isAfter(moment(pg.TimeFilter()).utc())?'Click to edit this value':'Not allowed to edit this value')#",
                    },
                },
            ...
            beforeEdit: function(e) {
                ...
                var timeStamp = new Date(moment(data.TimeStamp).utc());
                console.log(timeStamp);
                var timefilter = new Date(moment(pg.TimeFilter()).utc());
